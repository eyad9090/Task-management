...
/**
 * deal with make report page of project manager
 */
public class ReportManager extends JFrame {
    ...
    String[] columns = {"id","employee","report"};
    ...
    public ReportManager(User user) {
        this.user = user;
    ...
    private void setAddButton()
    {
        ...
        component.createButton(addTime,"../image/adder_before.png","../image/adder_after.png",x,y);
        addTime.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent e) {
                String email=(String) emailField.getSelectedItem();
                String r=penaltyField.getText();
                try {
                    ...
                    {
                        message.setText("please enter the report");
                        message.setForeground(Color.red);
                        JOptionPane.showMessageDialog(null, message, "CONFIRMED", JOptionPane.INFORMATION_MESSAGE);
                    }
                    else
                    {
                        report.setUserId(id);
                        report.setReport(r);
                        if(reportController.add(report))
                        {
                            message.setText("Report added successfully");
    ...
    private void setUpdateButton() {
        ...
        update.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                String r=penaltyField2.getText();
                if(id.isEmpty())
                {
                ...
                {
                    message.setText("please fill the details of report");
                    message.setForeground(Color.red);
                    JOptionPane.showMessageDialog(null, message, "CONFIRMED", JOptionPane.INFORMATION_MESSAGE);
                }
                else
                {
                    ...
                    report.setReport(r);
                    try {
                        if(reportController.update(report))
                        {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                else
                {
                    ...
                    if (choice == JOptionPane.YES_OPTION) {
                        try {
                            reportController.delete(Integer.parseInt(id));
                            message.setText("Report deleted successfully");
                            message.setForeground(Color.black);
                            JOptionPane.showMessageDialog(null, message, "CONFIRMED", JOptionPane.INFORMATION_MESSAGE);
                            referesh_table();
                            idField.setText("");
                            ...
                            message.setText("please make sure you have choosed the report from table");
                            message.setForeground(Color.red);
                            JOptionPane.showMessageDialog(null, message, "CONFIRMED", JOptionPane.INFORMATION_MESSAGE);
                        }
                    } else if (choice == JOptionPane.NO_OPTION) {
                        message.setText("Your report is safe");
                        message.setForeground(Color.BLACK);
                        JOptionPane.showMessageDialog(null, message, "CONFIRMED", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
